...
module.exports = function (sequelize, DataTypes) {
  return sequelize.define('ClientActivity', {
    id: {
      autoIncrement: true,
    ...
    clientId: {
      type: DataTypes.INTEGER,
      allowNull: true, // Nullable for changes not directly tied to a client
      references: {
        model: 'clients',
        key: 'id',
      },
    ...
    relatedModel: {
      ...
      allowNull: true, // Name of the related model (e.g., ClientAddress)
    },
    relatedModelId: {
      type: DataTypes.INTEGER,
